...
Styled.button(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n  padding: 0.3rem 0.5rem;\n  border: none;\n  border-radius: 5px;\n  position: absolute;\n  top: -0.8rem;\n  right: -0.8rem;\n  background-color: #556611;\n  color: #fff;\n  box-shadow: 0 0 5px 5px #a2b165;\n  cursor: pointer;\n"])));
Styled.img(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n  text-align: center;\n  width: 2rem;\n  height: 2rem;\n  padding: 0.5rem;\n"])));
Styled.p(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n  text-align: center;\n"])));
